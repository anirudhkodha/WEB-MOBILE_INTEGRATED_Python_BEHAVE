...
from pages.android.Member_Availability_Page import Availability


@given(u'I click on the "{bottom_nav}" icon at the bottom of the mobile screen')
def tap_on_tab(context, bottom_nav):
    context.availabilityTab = Availability(context.driver)
    if bottom_nav == "Availability":
        context.availabilityTab.click_on_availability_navigation()
